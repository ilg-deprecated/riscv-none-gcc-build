...
then
  ...
  # June 17, 2017
  BINUTILS_GIT_COMMIT=${BINUTILS_GIT_COMMIT:-"25eace0d418c7e0f87f859f6293f4b6c99beba38"}
else
...
then
  ...
  GCC_GIT_COMMIT=${GCC_GIT_COMMIT:-"5a282a3bc4e0f8700733dbf2c4d41aa528537e61"}
else
...
then
  ...
  NEWLIB_GIT_COMMIT=${NEWLIB_GIT_COMMIT:-"1e9006fd588a7b7728a0692c014ea2e8f5fd4177"}
else
